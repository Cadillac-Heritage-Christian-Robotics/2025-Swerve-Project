...
public class ShooterSubsystem extends SubsystemBase {
    ...
    final TalonFXConfiguration flywheelfollowerConfig = new TalonFXConfiguration();
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Intake | Conveyor | Applied Output", feederMotor.getConfigurator().apply(feederConfig).value);
    SmartDashboard.putNumber("Intake | Conveyor | Applied Output", flywheelMotor.getConfigurator().apply(flywheelConfig).value);
    //SmartDashboard.putNumber("Shooter | Flywheel | Current", flywheelMotor.getOutputCurrent());
    SmartDashboard.putNumber("Intake | Conveyor | Applied Output", flywheelFollowerMotor.getConfigurator().apply(flywheelfollowerConfig).value);
